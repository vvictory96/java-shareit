...
import ru.practicum.shareit.RequestWithJson;
...
public class UserControllerTest {
    ...
    public void addUserTest() throws Exception {
        ...
        checkItemProp(mockMvc.perform(RequestWithJson.postJson("/users", user1)));
    }
    ...
    public void updateUserTest() throws Exception {
        ...
        MvcResult mvcResult = checkItemProp(mockMvc.perform(RequestWithJson.patchJson("/users/1", user1)));
